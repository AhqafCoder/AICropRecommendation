...
EDit - my team got slected in sih2025, but wid  different Problem statement  and we won it alsoo... and bagged 1.5lacs...

Edit on 22 july - Do u guys want to collaboratively work on this repo and make it more better ? and do opensource contribution , then open a issue!
<br>

Proof - https://www.instagram.com/p/DSP55bqCAmk/?utm_source=ig_web_button_share_sheet&igsh=MzRlODBiNWFlZA==
...
1. **User Input** → Mobile/Web Interface
2. **Data Processing** → AI/ML Models
3. **Intelligence Generation** → Recommendations & Insights
4. **Result Delivery** → Visual Dashboard & Explanations
...
- [🚀 Live Demo & Access Points](#-live-demo--access-points)
- [🏗️ Complete Platform Architecture](#️-complete-platform-architecture)
- [🎯 Core Platform Features](#-core-platform-features)

### 📁 **Component Documentation**
- [🧠 ai_v2/ - Core AI Engine & Crop Intelligence](#-ai_v2---core-ai-engine--crop-intelligence)
- [📱 androidapp/ - React Native Mobile Application](#-androidapp---react-native-mobile-application)
- [🖥️ backend/ - Express.js + FastAPI Marketplace & Analytics](#️-backend---expressjs--fastapi-marketplace--analytics)
- [🌐 client/ - Next.js Web Application & Dashboard](#-client---nextjs-web-application--dashboard)
- [🔬 diseases_detection_ai/ - Computer Vision Disease Detection System](#-diseases_detection_ai---computer-vision-disease-detection-system)
...
- [📊 AI Model Performance & Specifications](#-ai-model-performance--specifications)
- [🧪 Testing & Quality Assurance](#-testing--quality-assurance)
- [🔮 Platform Roadmap & Future Enhancements](#-platform-roadmap--future-enhancements)

### 🌱 **Impact & Business**
- [🌱 Agricultural Impact & Benefits](#-agricultural-impact--benefits)
- [📈 Business Model & Sustainability](#-business-model--sustainability)
- [🏆 Platform Success Metrics](#-platform-success-metrics)
- [📞 Support & Documentation Resources](#-support--documentation-resources)
...
#### **1. 🌾 Advanced Crop Recommendation Engine**
...
#### **2. 🔬 Computer Vision Disease Detection**
   ...
   - **🌿 Comprehensive Disease Coverage**: Supports **15 disease classes** across 3 major crop types
     ...
     - **Tomato**: Bacterial Spot, Early Blight, Late Blight, Leaf Mold, Septoria Leaf Spot, 
       Spider Mites, Target Spot, Yellow Leaf Curl Virus, Mosaic Virus, Healthy state
...
#### **3. 📊 Economic Intelligence & Profitability**
...
#### **4. 📱 Cross-Platform Mobile Application**
   ...
   - **📱 5 Comprehensive Application Screens**:
     1. **Dashboard/Home**: Agricultural insights overview with weather widgets
     2. **Scan**: Real-time camera integration for crop and disease detection
     3. **Analysis**: Historical data visualization and trend analysis
     4. **Shop**: Integrated marketplace for agricultural products and equipment
     5. **Profile**: User management, settings, and agricultural preferences
...
#### **6. 🛒 Integrated Marketplace & Analytics**
...
##### **🗺️ Regional Season Intelligence**
...
- **`POST /predict`** - Complete Agricultural Intelligence Suite
  - Integrated crop, fertilizer, and economic recommendations
...
- **`POST /predict/crop`** - Specialized Crop Recommendation
...
- **`POST /predict/fertilizer`** - Optimized Fertilizer Recommendations
  - NPK formulation suggestions with precise ratios
...
- **`POST /predict/economics`** - Comprehensive Economic Analysis
...
- **`POST /predict/explain`** - Advanced SHAP-based Explanations
  - Feature importance visualization
  - Decision boundary analysis
  - What-if scenario modeling
  - Sensitivity analysis for key parameters

##### **🛠️ Utility and Monitoring APIs**
...
- **`GET /models/info`** - Model Information and Metadata
  - Model version and training details
  - Feature importance rankings
  - Performance metrics and validation results
  - Training dataset statistics
  
- **`GET /features/importance`** - Feature Analysis Endpoint
...
**🌐 API Architecture:**
- **Express.js Routes**: `/api/marketplace`, `/api/users`, `/api/auth`, `/api/orders`
- **FastAPI Endpoints**: `/analytics`, `/insights`, `/reports`, `/data-processing`
...
- **Homepage** (`page.tsx`): Professional landing with feature showcase
- **Dashboard** (`/dashboard`): Central hub for agricultural insights
- **Recommendations** (`/recommend`): Crop recommendation interface
- **Disease Detection** (`/detection`): Computer vision disease analysis
- **Marketplace** (`/marketplace`): E-commerce interface for agricultural products
- **Analytics** (`/analytics`): Advanced data visualization and reporting
...
- **Core AI API**: http://localhost:8000 (FastAPI docs: `/docs`)
...
### **🌾 Crop Recommendation Journey**
1. **Web Application** (`/recommend`):
...
2. **AI Analysis** (`diseases_detection_ai/`):
...
1. **Product Discovery** (`client/marketplace`):
   - Professional e-commerce interface
   - Category-based product browsing
   - Advanced search and filtering options

2. **Vendor Management** (`backend/`):
...
### **🌾 Crop Recommendation System (ai_v2/)**
...
### **🔬 Disease Detection AI (diseases_detection_ai/)**
- **Architecture**: ResNet50 with custom classification head
...
- **📚 API Documentation**: Comprehensive Swagger UI at `/docs` endpoints
